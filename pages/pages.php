 ...
 *
 * FIXED: Push to Shopify now updates ONLY the Search engine listing
 *        (global.title_tag + global.description_tag metafields) + handle.
 *        Page content (body_html) is never touched.
 */
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center pt-2 border-top gap-2">
                      <div class="btn-group btn-group-sm">
                        ...
                        <button 
                          ...
                          onclick="previewSerp('<?php echo $pgId; ?>', '<?php echo htmlspecialchars(addslashes($shopCfg['domain'])); ?>')"
                        >
                      ...
                      <div class="d-flex gap-1.5">
                        ...
                        <button 
                          ...
                          onclick="return confirm('Update Search engine listing only on <?php echo htmlspecialchars($shopCfg['name']); ?>? (Page content will NOT be changed)');"
                        >
